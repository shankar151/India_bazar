<?php
	...
	if(isset($_POST['login'])){
		...
		$qs = "select * from admin_login where(admin_email='$a_email' and admin_password='$a_password')";
									...
									<div class="form-content-signin">
										...
										<form class="default-form signin-form" method="post">
											<div class="form-group">
												<input id="email" name="a_email" class="form-controllar" type="email" placeholder="Email Address">
												<span class="icon-user-1"></span>
											</div><!--/.form-group-->
											
											<div class="form-group">
												<input id="pass" name="a_password" class="form-controllar" type="password" placeholder="Password" required>
